// Site + updates worker: owns browser.daddyrad.com end to end.
...
const CANONICAL = 'https://browser.daddyrad.com';
const LEGACY_HOST = 'browserdaddy.significanthobbies.com';
const PAGES_HOST = 'browserdaddy-landing.pages.dev';
...
export default {
  ...
  async fetch(request, env) {
    ...
    if (url.hostname !== 'browser.daddyrad.com') {
