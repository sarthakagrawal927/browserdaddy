...
// which keeps every other path on browserdaddy.significanthobbies.com.
...
export default {
  ...
  async fetch(request, env) {
    ...
    if (url.hostname !== 'browserdaddy.significanthobbies.com' || !url.pathname.startsWith('/updates/')) {
